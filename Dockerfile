...
RUN conda config --append channels bioconda && \
	...
	conda install -c bioconda python=3.11 numpy=1.26 pandas=2.2 matplotlib=3.8 seaborn=0.13.2  biopython=1.85 geopandas=1.1.1 cartopy=0.25.0 contextily=1.6.2 && \
	conda clean -a -y
